...
namespace TexStyle.ApplicationServices.Implementation.YD {
    internal class MachineTypeService : IMachineTypeService {
        private IMachineTypeRepository _repo;
        public MachineTypeService(IMachineTypeRepository repo) {
            _repo = repo;
        }

        public async Task<MachineType> Create(MachineType o) {
            try {
        ...
        public async Task<MachineType> Delete(MachineType o) {
            try {
                o.IsDeleted = true;
        ...
        public async Task<List<MachineType>> GetBetweenDateRange(DateTime start, DateTime end) {
            try {
        ...
        public async Task<MachineType> GetById(long id) {
            try {
        ...
        public async Task<MachineType> Update(MachineType o) {
            try {
