...
namespace TexStyle.Core.CS {
    public class LCImportInTr : DefaultEntity {
        public LCImportInTr() {
            LCImportInTrDetails = new List<LCImportInTrDetail>();
        }
        ...
        public ICollection<LCImportInTrDetail> LCImportInTrDetails { get; set; }
    }
}
