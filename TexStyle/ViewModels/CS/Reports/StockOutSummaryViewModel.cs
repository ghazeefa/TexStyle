...
{   
    public class StockOutSummaryViewModel : DefaultViewModel
    {
        public StockOutSummaryViewModel()
        {


            SummaryDetail = new List<StockOutSummaryDetailViewModel>();
        ...
        public List<StockOutSummaryDetailViewModel> SummaryDetail { get; set; }
        ...
        public decimal GeneralConsumptionAmountSum { get; set; }

        public decimal Purchase { get; set; }
        public decimal PurchaseSum { get; set; }
        public decimal PurchaseRate { get; set; }
        public decimal PurchaseAmount { get; set; }
        public decimal PurchaseAmountSum { get; set; }
        ...
        public decimal IssunaceCKL6AmountSum { get; set; }
