...
namespace TexStyle.Areas.ChemicalStore.Controllers {
    ...
    public class LCImportInTrDetailController : Controller {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;
        private readonly TempDataViewModel _tempData;
        public LCImportInTrDetailController(IUnitOfWork uow, IMapper mapper) {
            _uow = uow;
            _mapper = mapper;
        ...
        public async Task<IActionResult> AddOrUpdate(long? id, TrDetailViewModel vm) {
            ...
            return RedirectToAction("Details", "LCImportInTr", new { Id=vm.DyeChemicalTrId });
        }
