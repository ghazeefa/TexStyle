...
namespace TexStyle.Areas.ChemicalStore.Controllers {
    ...
    public class ChemicalDilutionTrDetailController : Controller {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;
        private readonly TempDataViewModel _tempData;

        public ChemicalDilutionTrDetailController(IUnitOfWork uow, IMapper mapper) {
            _uow = uow;
            _mapper = mapper;
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        var oldo = await _uow.DyeChemicalTrDetailService.GetById(m.Id);
