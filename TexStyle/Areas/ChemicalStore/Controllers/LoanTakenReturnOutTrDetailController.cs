...
namespace TexStyle.Areas.ChemicalStore.Controllers
{
    ...
    public class LoanTakenReturnOutTrDetailController : Controller
    {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;
        private readonly TempDataViewModel _tempData;

        public LoanTakenReturnOutTrDetailController(IUnitOfWork uow, IMapper mapper)
        {
            _uow = uow;
            _mapper = mapper;
        ...
        public async Task<IActionResult> AddOrUpdate(long? id, long ParentId)
        {
            ...
            if (id.HasValue)
            {
                ...
                vm.DyeChemicalXrefDetailTrId = m.DyeChemicalXrefDetailTrId;
        ...
        public async Task<IActionResult> AddOrUpdate(long? id, TrDetailViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                  ...
                  //  m.DyeChemicalXrefDetailTrId = vm.DyeChemicalXrefDetailTrId;
                    if (!id.HasValue)
                    {
                        // create
            ...
            return RedirectToAction("Details", "LoanTakenReturnOutTr", new { Id = vm.DyeChemicalTrId });
        }
