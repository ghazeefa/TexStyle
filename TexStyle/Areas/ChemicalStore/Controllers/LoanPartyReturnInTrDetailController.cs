...
namespace TexStyle.Areas.ChemicalStore.Controllers {
    ...
    public class LoanPartyReturnInTrDetailController : Controller {
        private readonly IUnitOfWork _uow;
        private readonly IMapper _mapper;
        private readonly TempDataViewModel _tempData;
        public LoanPartyReturnInTrDetailController(IUnitOfWork uow, IMapper mapper) {
            _uow = uow;
            _mapper = mapper;
        ...
        //    return View(_uow.LoanPartyReturnInTrDetailService.GetAll());
        //}
        ...
        public async Task<IActionResult> AddOrUpdate(long? id, TrDetailViewModel vm)
        {
            ...
            return RedirectToAction("Details", "LoanPartyReturnInTr", new { Id = vm.DyeChemicalTrId });
        }
