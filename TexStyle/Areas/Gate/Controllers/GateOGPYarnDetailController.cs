...
namespace TexStyle.Areas.Gate.Controllers
{
    ...
    public class GateOGPYarnDetailController : Controller
    {
        public IUnitOfWork _uow { get; set; }
        public IMapper _map { get; set; }
        private readonly TempDataViewModel _tempData;
        public GateOGPYarnDetailController(IUnitOfWork uow, IMapper map)
        {
            _uow = uow;
            _map = map;
        ...
        public async Task<IActionResult> AddOrUpdate(long? id, GateTrDetailViewModel v)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //    //add
                    //    vm = _map.Map<GateTrDetail>(v);
                    //    _uow.GateTrDetailService.Create(vm);
            ...
            return RedirectToAction("Details", "GateOGPDyesChemical", new { id = vm.GateTrId });
        }
        [HttpPost]
        public async Task<IActionResult> Delete(long? id)
        {
            ...
            return new StatusCodeResult(400); return View();
        }
    }
}